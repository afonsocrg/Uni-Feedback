...
const dummyData = {
  ...
  aiSummary:
    "This course offers a comprehensive introduction to AI concepts with well-structured lectures and engaging projects. Students consistently praise the professor's teaching style and the practical hands-on approach, though some note the workload can be demanding during project deadlines.",
  emotions: ['Engaging', 'Challenging', 'Rewarding'],
  persona:
    'A motivated student who enjoys practical coding projects and appreciates clear explanations of complex topics.',
  pros: [
  ...
  submissions: [
    {
      ...
      date: 'Jan 15, 2024',
      comment:
        "Amazing course! The professor explains complex concepts in a way that's easy to understand. The projects were challenging but really helped solidify the material. Highly recommend taking this course if you're interested in AI."
    },
    {
      rating: 4,
      workload: 'Heavy',
      date: 'Jan 22, 2024',
      comment:
        'Great content and well-organized lectures. The workload is pretty heavy, especially during project deadlines. Make sure you have good time management skills. The final exam was tough but fair.'
    },
    {
      rating: 5,
      workload: 'Light',
      date: 'Feb 3, 2024',
      comment:
        "One of the best courses I've taken. The professor is super knowledgeable and passionate about the subject. The hands-on approach with real-world examples made learning enjoyable. Would definitely take another course with this professor."
    },
    {
      rating: 3,
      workload: 'Moderate',
      date: 'Feb 10, 2024',
      comment:
        'Decent course overall. The material is interesting but the pace can be quite fast. I struggled a bit with some of the more advanced topics. Office hours were helpful though. Would recommend having a strong programming foundation before taking this.'
    },
    {
      rating: 4,
