...
// -- UNCOMMENT THIS import '../../../packages/ui/dist/style.css'
// -- UNCOMMENT THIS import '../../../packages/ui/src/style.css'
import './app.css'
  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="apple-mobile-web-app-title" content="Uni Feedback" />
        <Meta />
        <Links />
      </head>
      <body>
