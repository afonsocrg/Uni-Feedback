        ...
        <section className="mb-12">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Only one account per student is allowed. Multiple accounts,
                shared accounts, or variations of the same email address will
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="mb-3 text-muted-foreground">
                To enter, you must submit at least one feedback for a course
                taken during the 2025/2026 academic year.
              </p>
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                If you submitted feedback before the giveaway period, those
                points remain valid where applicable. To activate your points
                for this giveaway, you must log in to the platform before the
                giveaway deadline (points will be awarded automatically).
              </p>
            </div>
          </div>
        </section>
