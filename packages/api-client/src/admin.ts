 ...
 */
export async function getAdminCourses(query?: AdminCoursesQuery): Promise<AdminCoursesResponse> {
  const params = new URLSearchParams()
  if (query?.page) params.set('page', query.page.toString())
  if (query?.limit) params.set('limit', query.limit.toString())
  if (query?.search) params.set('search', query.search)
 ...
 */
export async function getAdminDegrees(query?: AdminDegreesQuery): Promise<AdminDegreesResponse> {
  const params = new URLSearchParams()
  if (query?.page) params.set('page', query.page.toString())
  if (query?.limit) params.set('limit', query.limit.toString())
  if (query?.search) params.set('search', query.search)
 ...
 */
export async function getAdminFaculties(query?: AdminFacultiesQuery): Promise<AdminFacultiesResponse> {
  const params = new URLSearchParams()
  if (query?.page) params.set('page', query.page.toString())
  if (query?.limit) params.set('limit', query.limit.toString())
  if (query?.search) params.set('search', query.search)
  
  const url = params.toString() ? `/admin/faculties?${params}` : '/admin/faculties'
 ...
 */
export async function getAdminFeedback(query?: AdminFeedbackQuery): Promise<AdminFeedbackResponse> {
  const params = new URLSearchParams()
  if (query?.page) params.set('page', query.page.toString())
  if (query?.limit) params.set('limit', query.limit.toString())
  if (query?.search) params.set('search', query.search)
  ...
  const url = params.toString() ? `/admin/feedback?${params}` : '/admin/feedback'
